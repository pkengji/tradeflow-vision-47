    ...
    if (endpoint.startsWith('/positions')) {
      const mockPositions: Position[] = [
        ...
        },
        {
          ...
          leverage: 20,
          currentPrice: 2.7452,
          entrySignalPrice: 2.733,
          entryFillPrice: 2.7345,
          tp: 2.899,
          sl: 2.623,
          status: 'open',
        ...
        },
        {
          ...
          leverage: 15,
          currentPrice: 145.32,
          entrySignalPrice: 148.50,
          entryFillPrice: 148.42,
          tp: 140.00,
          sl: 152.00,
          status: 'open',
          openedAt: new Date(Date.now() - 2700000).toISOString(),
          pnl: 465.00,
          pnlPct: 2.09,
          tradingFees: 11.13,
          fundingFees: -1.50,
        ...
        },
        {
          ...
          leverage: 10,
          currentPrice: 1.0523,
          entrySignalPrice: 1.045,
          entryFillPrice: 1.0458,
          tp: 1.090,
          sl: 1.020,
          status: 'open',
